...
for firewall in firewalls:
    firewall_policy_ids.append(firewall["firewall_policy_id"])

for policy in firewall_policys:
    for firewall_policy_id in firewall_policy_ids:
        if policy["id"] == firewall_policy_id:
            print "----"
...
print "-----"
#print neutron_client.list_firewall_policies()

#for policy in neutron_client.list_firewall_policies()["firewall_policies"]:
#    print policy
